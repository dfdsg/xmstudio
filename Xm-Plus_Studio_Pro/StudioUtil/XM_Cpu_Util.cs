...
namespace XM_Tek_Studio_Pro.StudioUtil
{
    ...
    class XMBaseIfCtrl
    {
        public virtual bool WrImgWithHorizontal(byte[,] Pixels) { return true; }
        public virtual bool WrImgWithVertical(byte[,] Pixels) { return true; }
        public virtual bool WrImgWithPage(byte[,] Pixels) { return true; }
    }

    class XM_Cpu_Util : XMBaseIfCtrl
    {
